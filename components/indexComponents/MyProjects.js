...
<div>
	...
	<Row>
		<Col>
			<div>
				...
				<img className="me-photo" src="https://res.cloudinary.com/ddsihrmda/image/upload/v1510035230/SaintPaschalDevelopment_q2ng40.png" />
					<div>
	...
	<Row>
		<Col>
			<div>
				<h3>Troll Patrul</h3>
				<img className="me-photo" src="https://res.cloudinary.com/ddsihrmda/image/upload/v1510293169/TrollPatrul_lpnv0f.png" />
				    <div>
	...
	<Row>
		<Col>
			<div>
				<h3>Politihub</h3>
				<img className="me-photo" src="https://res.cloudinary.com/ddsihrmda/image/upload/v1510293167/Politihub_gu1dvi.png" />
				 <div>
	...
	<Row>
		<Col>
			<div>
				<h3>Reel Films</h3>
				<img className="me-photo" src="https://res.cloudinary.com/ddsihrmda/image/upload/v1510293167/ReelFilms_rwgj6z.png" />
